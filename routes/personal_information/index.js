module.exports = function Personal_informationRoutes(app) {
  ...
  //  RESOURCE VARIABLES
  var resourceName = 'personal_information';
  var parentResourceName = '';
  var resourcesLength = 1;
  var lineage = 'personal_information';
  var lineageArray = ['personal_information'];
  ...
  app.get('/personal_information', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
  ...
  app.put('/personal_information', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    var instancesArray = [];
  ...
  app.del('/personal_information', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    req.params[resourceName + 'InstanceId'] = resourceName;
