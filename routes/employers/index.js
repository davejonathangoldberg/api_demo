module.exports = function EmployersRoutes(app) {
  ...
  var lineage = 'employers';
  var lineageArray = ['employers'];
  ...
  app.get('/employers/:employersInstanceId', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    if (parentResourceName !== ''){
  ...
  app.put('/employers/:employersInstanceId', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    var instancesArray = [];
  ...
  app.del('/employers/:employersInstanceId', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    if (parentResourceName !== ''){
